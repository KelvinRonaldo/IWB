...
<html>
    ...
    <body>
        <form name="frmcalcular" method="post" action="switch.php">
        <div id="" class="center">
        ...
        <div id="conteudo">
            ...
            <div id="">
                <div>
                    Valor 1:
                    <input type="text" name="txtvalor1" value="<?php echo($valor1) ?>" onkeypress="return Validar(event);"> 
                    
                </div>
                <div>
                    Valor 2:
                    <input type="text" name="txtvalor2" value="<?php echo($valor2) ?>" onkeypress="return Validar(event);">
                </div>
