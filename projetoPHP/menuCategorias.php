    ...
    <div id="container-categoria-menu" class="container-categoria-menu">
                    <!-- MENU À ESQUERDA DA PAGINA -->
                        <div id="menu-esq" class="menu-categoria-close">
                            ...
                            <a href="?cod_categoria=0&cod_subcategoria=0">
                                <div class="item-menu-esq-clean">
                            ...
                            <div class="item-menu-esq">
                                ...
                                <a href="?cod_categoria=<?= $codCategoria?>&cod_subcategoria=0"><h3><?php echo $categoria; ?></h3></a>
                                <div class="icon-subcategorias">
                                    <figure>
                                ...
                                <ul class="caixa-subitem-menu-esq esconder">
                                    ...
                                    <li class="subitem-menu-esq">
                                        <!-- <h3 class="subitem-menu-esq-h3" onclick="buscarPorProdutosFiltros(<?= $codCategoria.', '.$codSubcategoria; ?>)"><?= $subcategoria?></h3> -->
                                        <a href="?cod_categoria=<?= $codCategoria?>&cod_subcategoria=<?= $codSubcategoria?>"><h3 class="subitem-menu-esq-h3"><?= $subcategoria?></h3></a>
                                    </li>
                                    <?php
                                        }
                                    ?>
